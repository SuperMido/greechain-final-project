const SupplyChainUser = artifacts.require('../ethereum/contracts/SupplyChainUser');
const SupplyChainStorage = artifacts.require('../ethereum/contracts/SupplyChainStorage');
