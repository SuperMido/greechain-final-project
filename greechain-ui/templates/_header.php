    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <div class="top-left-part"><a class="logo" href=""><b><img src="plugins/images/icon.png" alt="home" /></b><span class="hidden-xs">GreeChain</span></a></div>
                <div class="top-right-part">
                    <a class="text-light" href="/"><button type="button" class="btn btn-outline-danger">Logout &nbsp;<i class="icon-logout text-red"></i> </button></a>
                </div>
            </div>
        </nav>
        <!-- Left navbar-header -->
