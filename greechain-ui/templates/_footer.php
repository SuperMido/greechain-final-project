<footer class="footer text-center"> 
            © <?php echo date('Y');?> Coffee SupplyChain by <a href="https://github.com/SuperMido" target="_blank">Tran Quang Huy</a> 
        </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
...
<!--     <script src="plugins/bower_components/morrisjs/morris.js"></script> -->
    ...
    <?php 
        ...
        elseif(isset($_SERVER['SCRIPT_NAME']) && strpos($_SERVER['SCRIPT_NAME'], "user") !== false)
        {
            ?>
