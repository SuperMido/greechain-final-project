...
$("#editUser").on('click',function(){
  getUser(globUserContract, function(data){
       ...
       var btnViewImage = '<a href="'+profileImageLink+'" target="_blank" class=" text-danger pull-left"><i class="fa fa-eye"></i> View Image</a>';
    ...
    {   
        ...
        if (elem.status == "FARM_INSPECTION") {
          ...
          tr+=`<td><span class="label label-danger font-weight-100">Not Available</span> </td>
              ...
              <td><span class="label label-danger font-weight-100">Not Available</span> </td>
              <td><span class="label label-danger font-weight-100">Not Available</span> </td>
              <td><a href="view-batch?batchNo=`+batchNo+`&txn=`+transactionHash+`" target="_blank" class="text-inverse p-r-10" data-toggle="tooltip" title="View"><i class="ti-eye"></i></a> </td>
          </tr>`;
