...
function buildCultivationTable(finalEvents)
{
    ...
    {   
        ...
        var urlViewBatch = host+'/'+'view-batch?batchNo='+batchNo+'&txn='+transactionHash;
        var qrUrl = 'https://chart.googleapis.com/chart?cht=qr&chld=H|1&chs=400x400&chl='+urlViewBatch;
        ...
        var commQrTd = `<td><a href="`+qrUrl+`" title="`+transactionHash+`" class="qr-code-magnify" data-effect="mfp-zoom-in">
				        	<img src="`+qrUrl+`" class="img-responsive" style="width:30px; height:30px;">
				        </a>
				    </td>`;
		var commActionTd = `<td><a href="view-batch?batchNo=`+batchNo+`&txn=`+transactionHash+`" target="_blank" class="text-inverse p-r-10" data-toggle="tooltip" title="View"><i class="ti-eye"></i></a> </td>`;		    
