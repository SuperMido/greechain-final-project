var globIcoAddress = {
		...
		'CoffeeMain': "0x17705628f21956a5d5d58765e2b12da94acab3c8",
		'CoffeeUser': "0x0a2936e16254b88c46153f74294a22858d7a43dd",
		'Storage': "0x90d8f83084ebdea44588c36dc368376d2e44d4c2"
};

var globAdminAddress = "0xed707a377eef829bfdce8ec5682f972ba9e4dfb1";
...
window.addEventListener('load', function () {
	...
	getCurrentAccountAddress((address) => {
		...
		if (currentPanel == "admin") {
			if(address != globAdminAddress) window.location = "index";
		}
	});
	...
	if (currentPanel != "view-batch") updateLoginAccountStatus();
