            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 ">
                        <div class="white-box">
                            ...
                            <ul class="list-inline two-part">
                                <li><i class="icon-layers text-purple"></i></li>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                             <a href="javascript:void(0);" class="btn btn-info pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light mb-4" onclick="javascript:$('#batchFormModel').modal();">Create Batch</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 col-sm-12">
                        <div class="white-box">
                             <a href="javascript:void(0);" id="userFormClick" class="btn btn-info pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light mb-4">Create User</a>
                            <h3 class="box-title">Users</h3> 
                            <div class="table-responsive">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2 class="modal-title">Create Batch</h2>
                        </div>
