                        ...
                        <div class="white-box">
                                        ...
                                        <form id="updateUserForm" onsubmit="return false;">
                                            <fieldset style="border:0;">
                                                <div class="form-group">
                                                    <label class="control-label pull-left" for="fullname">Full Name <i class="red">*</i></label>
                                                    <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Name" data-parsley-required="true">
                                                </div>                              
                                                <div class="form-group">
                                                    <label class="control-label pull-left" for="contactNumber">Contact No<i class="red">*</i></label>
                                                ...
                                                <div class="form-group" hidden>
                                                    <label class="control-label pull-left" for="role">Role </label>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label pull-left" for="userProfileHash">Profile Image <i class="red">*</i></label>
                            ...
                            <form id="harvesterForm" class="mfp-hide white-popup-block ">
                                ...
                                <fieldset style="border:0;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="temperatureUsed">Temperature (in Celsius)</label>
                            ...
                            <form id="processingForm" class="mfp-hide white-popup-block">
                                ...
                                <fieldset style="border:0;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="processingTemperature">Temperature (in Celsius)</label>
